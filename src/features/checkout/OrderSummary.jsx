...
const OrderSummary = () => {
  ...
  const address = useSelector(shippingAddress);
  ...
  return (
    <div className="mx-auto mt-12 bg-white max-w-7xl px-4 rounded-xl sm:px-6 lg:px-8">
      ...
      <div className="px-6 border-b-2 pb-4">
                  ...
                  <div className="flex flex-1 items-end justify-between text-sm">
                    ...
                    <div className="text-gray-600">
                      ...
                      value={item.quantity}
                        name="quantity"
                        id="quantity"
                        className="border-none bg-gray-100 rounded-lg py-1"
                      >
                    ...
                    <div className="flex">
                      ...
                      onClick={e=>handleRemove(e,item.id)}
                        type="button"
                        className="font-medium text-[#f63b60]"
                      >
                        Remove
                      </button>
                    </div>
        ...
        <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
          <p>
            ...
            <Link to={"/"}>
              <button
                type="button"
                className="font-medium ml-2 text-[#f63b60]"
